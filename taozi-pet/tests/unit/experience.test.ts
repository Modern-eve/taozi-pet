...
test('settings accept only complete, finite values within pet scale range', () => {
  const valid = { edgeSnap: true, alwaysOnTop: true, typingReaction: false, clickThrough: false, petScale: 0.8, autoStart: true, autoStartInit: true, randomWalk: 2, devMode: false };
