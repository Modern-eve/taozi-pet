...
def main():
    ...
    parser.add_argument("--inner", type=int, default=28, help="内容区域边长（默认 28，留 2px 内边距）")
    ...
    head = head.resize((args.inner, args.inner), Image.LANCZOS)

    canvas = Image.new("RGBA", (args.size, args.size), (0, 0, 0, 0))
    offset = (args.size - args.inner) // 2
